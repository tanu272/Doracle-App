    ...
    <View style={styles.MainContainer}>
      ...
      activeOpacity={0.1}>
       ...
       <View style={{paddingLeft:150}}>
        ...
        <View style={{justifyContent :"space-evenly", paddingLeft: 65, marginTop: 10}}><Text style ={{color: "lightblue", fontSize: 20,}}>Progress of the Patient</Text></View>
      ...
      <View style={{justifyContent :"space-evenly", paddingLeft: 80}}><Text style ={{color: "lightblue", fontSize: 20,}}>{"\n"} Patient Condition</Text></View>
