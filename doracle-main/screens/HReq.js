...
function Requirementoldpatient ({ navigation, route }) {
  ...
  <ScrollView style={styles.scrollView}>
      ...
      activeOpacity={0.1}>
        ...
        <Text style={{backgroundColor: '#003f5c',}}>{"\n"}</Text>
        <Text style={{color:'#173604', fontSize:30}}>Patient Details</Text>
        <Text style={{backgroundColor: '#003f5c',}}>{"\n"}</Text>
        <Text style={{backgroundColor: '#003f5c',}}>{"\n"}</Text>
        <Text style={{color:'#173604', fontSize:20}}>Name - Tanushree Bhattacharya</Text>
        <Text style={{color:'#173604', fontSize:20}}>Contact - 9434559724 </Text>
        <Text style={{color:'#173604', fontSize:20}}>Patient id - INDFueqP8</Text>
        <Text style={{color:'#173604', fontSize:20}}>Email - tanub922@gmail.com</Text>
        <Text style={{backgroundColor: '#003f5c',}}>{"\n"}</Text>
        <Text style={{backgroundColor: '#003f5c',}}>{"\n"}</Text>
  
  
        <Text style={{color:'#173604', fontSize:40}}>Requirement Log</Text>
        <Text style={{backgroundColor: '#003f5c',}}>{"\n"}</Text>
        <Text style={{backgroundColor: '#003f5c',}}>{"\n"}</Text>
    ...
    <Text style={{backgroundColor: '#003f5c',}}>{"\n"}</Text>
        ...
        <Text style={{color:'#173604', fontSize:20}}>Add Requirement Status</Text>
        <Text style={{backgroundColor: '#003f5c',}}>{"\n"}</Text>
